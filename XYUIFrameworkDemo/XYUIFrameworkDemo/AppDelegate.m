...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.window.rootViewController = [XYTabBarViewController sharedInstance];
...
- (void)setUpXYUIConfig{
    [XYUIApperanceConfig xy_setTabBarViewControllers:@[[HomeViewController new],[MyViewController new]]];
}
