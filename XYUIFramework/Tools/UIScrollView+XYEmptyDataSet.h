...
/**
 ...
 @discussion It will work automatically, by just conforming to EmptyDataSetSource, and returning the data you want to show.
 */

@interface UIScrollView (XYEmptyDataSet)

/** The empty datasets data source. */
@property (nonatomic, weak, nullable) IBOutlet id <EmptyDataSetSource> emptyDataSetSource;
...
/**
 ...
 @discussion The data source must adopt the EmptyDataSetSource protocol. The data source is not retained. All data source methods are optional.
 */
...
- (CGFloat)buttonWidthForEmptyDataSet:(UIScrollView *_Nullable)scrollView;
...
/**
 ...
 @discussion The delegate can adopt the EmptyDataSetDelegate protocol. The delegate is not retained. All delegate methods are optional.
 ...
 */
- (void)emptyDataSet:(UIScrollView *_Nullable)scrollView didTapView:(UIView *_Nullable)view;
 ...
 */
- (void)emptyDataSet:(UIScrollView *_Nullable)scrollView didTapButton:(UIButton *_Nullable)button;
