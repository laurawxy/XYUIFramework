...
#import "XYWebViewControllerActivity.h"

@implementation XYWebViewControllerActivity
...
- (UIImage *)activityImage {
    ...
    NSString *resourcePath = [bundle pathForResource:@"XYWebViewController" ofType:@"bundle"] ;
...
@implementation XYWebViewControllerActivityChrome
...
- (NSString *)activityTitle {
    ...
    return NSLocalizedStringFromTableInBundle(@"OpenInChrome", @"XYWebViewController", bundle, @"Open in Chrome");
...
@implementation XYWebViewControllerActivitySafari
- (NSString *)activityTitle {
    ...
    return NSLocalizedStringFromTableInBundle(@"OpenInSafari", @"XYWebViewController", bundle, @"Open in Safari");
}
